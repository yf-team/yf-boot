...
import com.pw.system.modules.plugin.dto.PluginSchemaDTO;
import com.pw.system.modules.plugin.entity.PluginSchema;
import com.pw.system.modules.plugin.mapper.PluginSchemaMapper;
import com.pw.system.modules.plugin.service.PluginSchemaService;
...
public class PluginSchemaServiceImpl extends ServiceImpl<PluginSchemaMapper, PluginSchema> implements PluginSchemaService {
    ...
    public IPage<PluginSchemaDTO> paging(PagingReqDTO<PluginSchemaDTO> reqDTO) {
        ...
        //转换结果
        IPage<PluginSchemaDTO> pageData = JSON.parseObject(JSON.toJSONString(page), new TypeReference<Page<PluginSchemaDTO>>(){});
        return pageData;
    }
